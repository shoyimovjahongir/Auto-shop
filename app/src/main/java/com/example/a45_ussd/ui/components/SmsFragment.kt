...
class SmsFragment : Fragment(R.layout.fragment_sms) {
    ...
    lateinit var internetViewAdapter: SmsViewPagerAdapter
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.apply {
            ...
            internetViewAdapter = SmsViewPagerAdapter(
                requireActivity(),
                internetList,
                object : SmsViewPagerAdapter.OnClicListener {
...
//            tabLayout.addTab(tabLayout.newTab().setText(internetList[2].turi))
            ...
            trafikniTekshirish.setOnClickListener {
                ...
                builder.setTitle("Sizning smslaringiz:")
                builder.setMessage("Sizda 500 sms mavjud !!!")
